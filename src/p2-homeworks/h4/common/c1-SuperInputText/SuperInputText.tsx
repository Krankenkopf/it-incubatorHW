import React, {ChangeEvent, DetailedHTMLProps, InputHTMLAttributes, KeyboardEvent, LabelHTMLAttributes} from 'react'
...
const SuperInputText: React.FC<SuperInputTextPropsType & SuperLabelPropsType> = (
    {
